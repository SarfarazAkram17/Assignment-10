...
<div className="bg-base-200 py-16 px-6 md:px-20">
  ...
  <div className="grid md:grid-cols-3 gap-8">
    <div className="p-6 bg-base-100 shadow-md rounded-xl text-center">
      <img src="https://i.ibb.co/JRkFhhK/verify.png" alt="Verified Freelancers" className="mx-auto w-16 mb-4"/>
    ...
    <div className="p-6 bg-base-100 shadow-md rounded-xl text-center">
      <img src="https://i.ibb.co/7WyxLvN/shield.png" alt="Secure Payments" className="mx-auto w-16 mb-4"/>
    ...
    <div className="p-6 bg-base-100 shadow-md rounded-xl text-center">
      <img src="https://i.ibb.co/YyF5NRv/clock.png" alt="Quick Turnaround" className="mx-auto w-16 mb-4"/>
